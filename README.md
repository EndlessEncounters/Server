...
**non-authenticated GET**
_Story events account for all instances in the game, everything from the text-based start screen, to the level up and combat scenarios are story events._
